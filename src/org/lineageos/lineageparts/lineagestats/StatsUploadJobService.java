...
public class StatsUploadJobService extends JobService {
    ...
    public static final int JOB_TYPE_HAVOC = 1;
                    ...
                    case JOB_TYPE_HAVOC:
                        try {
                            JSONObject json = buildStatsRequest(deviceId, deviceName,
                                    deviceVersion, deviceBuildDate, deviceAndroidVersion, deviceTag,
                                    deviceCountry, deviceCarrier, deviceCarrierId);
                            success = uploadToHavoc(json);
    ...
    private JSONObject buildStatsRequest(String deviceId, String deviceName, String deviceVersion,
        ...
        request.put("device_build_date", deviceBuildDate);
        request.put("device_android_version", deviceAndroidVersion);
    ...
    private boolean uploadToHavoc(JSONObject json) throws IOException {
        final Uri uri = Uri.parse(getString(R.string.stats_havoc_url));
        ...
        try {
            ...
            if (DEBUG) Log.d(TAG, "havoc server response code=" + responseCode);

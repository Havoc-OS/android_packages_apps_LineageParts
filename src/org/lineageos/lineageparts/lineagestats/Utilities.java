...
public class Utilities {
    ...
    public static String getDevice() {
        return SystemProperties.get("ro.havoc.device", Build.PRODUCT);
    }

    public static String getModVersion() {
        return SystemProperties.get("ro.havoc.version", Build.DISPLAY);
    }
    ...
    public static String getAndroidVersion() {
        return SystemProperties.get("ro.havoc.version", Build.VERSION.RELEASE);
    }
